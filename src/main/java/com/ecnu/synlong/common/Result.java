...
//
//import edu.uiowa.cs.clc.kind2.results.*;
//import edu.uiowa.cs.clc.kind2.results.Object;
//
...
//     * @return {@link edu.uiowa.cs.clc.kind2.results.Result} which contains the result of analyzing kind2 output.
//     */
//    public static edu.uiowa.cs.clc.kind2.results.Result analyzeJsonResult(String json) {
//        edu.uiowa.cs.clc.kind2.results.Result kind2Result = new edu.uiowa.cs.clc.kind2.results.Result();
//
...
//            edu.uiowa.cs.clc.kind2.results.Object kind2Object = edu.uiowa.cs.clc.kind2.results.Object.getKind2Object(objectType);
//
//            if (kind2Object == edu.uiowa.cs.clc.kind2.results.Object.kind2Options) {
//                Options options = new Options(jsonElement);
//
//                this.options = options;
//            }
//
//            if (kind2Object == edu.uiowa.cs.clc.kind2.results.Object.log) {
//                Log log = new Log(this, jsonElement);
//                this.kind2Logs.add(log);
//            }
//
//            if (kind2Object == edu.uiowa.cs.clc.kind2.results.Object.lsp) {
...
//            }
//
//            if (kind2Object == edu.uiowa.cs.clc.kind2.results.Object.analysisStart) {
//                // define new analysis
//                kind2Analysis = new Analysis(jsonElement);
//            }
//
//            if (kind2Object == edu.uiowa.cs.clc.kind2.results.Object.analysisStop) {
...
//            }
//
//            if (kind2Object == edu.uiowa.cs.clc.kind2.results.Object.property) {
//                if (kind2Analysis != null) {
...
//            }
//
//            if (kind2Object == edu.uiowa.cs.clc.kind2.results.Object.postAnalysisStart) {
...
//            }
//
//            if (kind2Object == edu.uiowa.cs.clc.kind2.results.Object.postAnalysisEnd) {
...
//        edu.uiowa.cs.clc.kind2.results.Result.printingCounterExamplesEnabled = value;
//    }
//
//    /**
...
//        edu.uiowa.cs.clc.kind2.results.Result.printingUnknownCounterExamplesEnabled = value;
//    }
//
//    /**
...
//        edu.uiowa.cs.clc.kind2.results.Result.printingLineNumbersEnabled = value;
//    }
//
//    /**
...
//        edu.uiowa.cs.clc.kind2.results.Result.openingSymbols = symbols;
//    }
//
//    /**
//     * Set the opening symbols for printing lustre names
...
//        edu.uiowa.cs.clc.kind2.results.Result.closingSymbols = symbols;
//    }
//
//    /**
...
//        edu.uiowa.cs.clc.kind2.results.Result.realPrecision = realPrecision;
//    }
//
//    /**
...
//        edu.uiowa.cs.clc.kind2.results.Result.realRoundingMode = realRoundingMode;
//    }
//
//    /**
